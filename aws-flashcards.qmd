...
A machine learning service that uses computer vision to automate visual inspection of industrial products.

:::

::: {.callout-note collapse="true"}
### AWS Lookout for Equipment
A machine learning service that uses sensor data to detect abnormal equipment behavior and prevent costly downtime.

:::

::: {.callout-note collapse="true"}
### AWS Lookout for Metrics
A machine learning service that uses anomaly detection to monitor business metrics and alert on unexpected changes.
